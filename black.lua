...
send(msg.chat_id,msg.id,"⌯مرحبا عزيزي في مصنع الحمايه المجاني لسورس سيلفا \n⌯مبرمج السورس @uu_u_4","html",true, false, false, true, reply_markup)
return false 
end
---making user
...
{
{text = '𝚃𝙸𝙼', url = "https://t.me/uu_u_4"}
},
}
